...
**TODO** - change to:
"that points within a cluster are close together, while the clusters themselves are far apart"*
 (Rao, 1964, p. 351).  Rao, C.R. (1964). The use and interpretation of principal component analysis in applied research. Sankhya A 26, 329-358.
{ END definition }
...
of within-cluster distances (TODO: within cluster sum of squares,
the same as k-means).
Together with the linkages presented in this
