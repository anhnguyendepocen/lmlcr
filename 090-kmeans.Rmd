...
agglomerative strategy [@ward]

divisive strategy [@edwards_sforza]

exhaustive search over MST - each ${n - 1 \choose k-1}$ possible splits of an MST [@calinski_harabasz]

??? - agglomerative over MST

??? - divisive over MST

k-means - fixed-point iteration algorithm ([@macqueen] LLoyd, 1957)
...
the Hartigan-Wong, Lloyd (a.k.a. Lloyd-Forgy) and MacQueen [@macqueen] algorithms.
