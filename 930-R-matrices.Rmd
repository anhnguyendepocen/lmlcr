# Matrix Algebra in R   {#appendix:rmatrix}
...
```{r matrix-ex2d,echo=FALSE,fig.height=5,fig.cap="Currency exchange rates relative to 1999-01-04 (with EUR as the base currency)"}
