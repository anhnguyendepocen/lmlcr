# Shallow and Deep Neural Networks {#chap:images}
...
![Neuron as a mathematical (black box) function; image based on: https://en.wikipedia.org/wiki/File:Neuron3.png by Egm4313.s12 at English Wikipedia, licensed under the Creative Commons Attribution-Share Alike 3.0 Unported license](figures/neuron){#fig:neuron}
...
![A simple model of an artificial neuron](figures/perceptron){#fig:perceptron}
...
![Binary logistic regression](figures/logistic_regression_binary){#fig:logistic_regression_binary}
...
![Multinomial logistic regression](figures/logistic_regression_multiclass){#fig:logistic_regression_multiclass}
...
![A multi-layer neural network](figures/nnet){#fig:nnet}
