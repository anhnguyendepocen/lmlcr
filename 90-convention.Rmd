...
#### Notation Convention -- Logic and Set Theory {.unnumbered}
...
$x\in A\cup B$ iff $x\in A$ or $x\in B$ ($\cup$ = cup)

$A\cap B$ -- intersection (sum) of two sets,
$x\in A\cap B$ iff $x\in A$ and $x\in B$ ($\cup$ = cap)
...
$\bigcup_{i=1}^n C_i = C_1\cup C_2\cup \dots \cup C_n$ -- the union
of $n$ indexed sets


$\bigcap_{i=1}^n C_i = C_1\cap C_2\cap \dots \cap C_n$ -- the intersection
of $n$ indexed sets




#### Notation Convention -- Symbols {.unnumbered}
...
$X, x, \mathbf{X}, \boldsymbol{x}$ -- inputs (usually)

$Y, y, \mathbf{Y}, \boldsymbol{y}$ -- outputs

$\hat{Y}, \hat{y}, \hat{\mathbf{Y}}, \hat{\boldsymbol{y}}$ --  predicted outputs (usually)
...
#### Notation Convention -- Vectors and Matrices {.unnumbered}
...
#### Notation Convention -- Functions {.unnumbered}
...
#### Notation Convention -- Sums and Products {.unnumbered}
...
For example, n-factorial, $n!$
is given by $n! = \prod_{i=1}^n i = 1\cdot 2 \cdot 3\cdot \dots\cdot n$
