...
```{r ssi-map,echo=-c(1,2),results="hide",cache=TRUE,message=FALSE,fig.cap="OECD countries grouped w.r.t. the SSI dimensions (complete linkage, $K=3$)"}
...
Figure \@ref(fig:ssi-dendrogram-complete)..................
...
```{r ssi-dendrogram-complete,fig.cap="Cluster dendrogram generated by complete linkage",echo=-1}
par(mar=c(0.5, 2, 0.5, 0.5))
plot(h, xlab=NA, main=NA);
box()
```
