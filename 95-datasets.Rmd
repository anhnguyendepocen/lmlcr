...
publishes currency exchange rates (relative to EUR)
...
* `currency_exchange_single.csv`, which gives only the AUD/EUR rates
...
* `currency_exchange_diff.csv`, which gives relative daily changes
    in the AUD/EUR rates (we use it for building example
